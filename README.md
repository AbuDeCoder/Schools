...
To build the final jar and optimize the Application application for production, run:
...
Then navigate to [http://localhost:9500](http://localhost:9500) in your browser.
